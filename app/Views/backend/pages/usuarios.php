                         ...
                         <tbody>
                             ...
                             <?php foreach ($usuarios as $usuarios_item) : ?>
                                 ...
                                 <tr role="row" class="odd">
                                     <td class="sorting_1"><?= $usuarios_item['usuario'] ?></td>
                                     <td><a href="#" data-toggle="modal" data-target="#Modal<?= $usuarios_item['id'] ?>"><i class="fas fa-key"></i> Mudar Senha</a></td>
                                     <td><a href="/admin/usuarios/excluir/<?= $usuarios_item['id'] ?>" onclick="return confirm('Deseja mesmo Excluir o usuário <?= $usuarios_item['usuario'] ?>?')"><i class="fas fa-trash"></i> Excluir</a></td>
                                 </tr>
